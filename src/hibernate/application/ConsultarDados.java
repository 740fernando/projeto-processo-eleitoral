...
/*
 * Classe respons�vel por ler algumas informa��es cadastradas no banco de dados.
 * Para que o m�todo main() funcione, os dados devem estar previamente cadastrados.
 */
...
public class ConsultarDados {
	...
	public static void main(String[] args) {
		...
		//lista os candidatos a presidente
	...
	private static void mostrarCandidatosECargos(Session session) {
		...
		for(Candidato c : r) {
			System.out.println("Nome do candidato a presidente : "+c.getNome());
		}
	}
	/*
